...
def check_events(sw_settings, screen, stats, sb, play_button, ship, aliens, bullets):
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(sw_settings, screen, stats, sb, play_button, ship, aliens, bullets, mouse_x, mouse_y)


def check_play_button(sw_settings, screen, stats, sb, play_button, ship, aliens, bullets, mouse_x, mouse_y):
...
def update_aliens(sw_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    if pygame.sprite.spritecollideany(ship, aliens):
        ship_hit(sw_settings, screen, stats, sb, ship, aliens, bullets)
...
def ship_hit(sw_settings, screen, stats, sb, ship, aliens, bullets):
...
def check_aliens_bottom(sw_settings, stats, screen, sb, ship, aliens, bullets):
